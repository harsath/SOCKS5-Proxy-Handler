...
int main(int argc, char *argv[]){
	...
	socket_handler->connect_proxy_socks5("www.ipinfo.io", 80, SOCKS5_RESOLVE::REMOTE_RESOLVE); // connecting to public ip check site through Tor daemon's SOCKS server
